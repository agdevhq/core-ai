...
describe('createXAIChatModel', () => {
    it('should create model metadata', () => {
        const model = createXAIChatModel(createMockClient(), 'grok-4.3');
...
describe('generate', () => {
    it('should map reasoning_content and preserve it in follow-up requests', async () => {
        ...
        const model = createXAIChatModel(createMockClient(create), 'grok-4.3');
                    ...
                    choices: [
                        {
                            index: 0,
                            finish_reason: null,
                            delta: { reasoning_content: 'Think' } as XAIDelta,
                        },
                    ],
                }),
                asChunk({
