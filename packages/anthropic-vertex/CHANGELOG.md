...
- Updated dependencies [3197a6b]
    - @core-ai/anthropic@0.18.0
...
- 381fd9d: Allow Anthropic Vertex users to disable strict tool schemas with the `useStrictToolSchemas` provider option.

### Patch Changes

- Updated dependencies [f87ff4f]
- Updated dependencies [381fd9d]
    - @core-ai/anthropic@0.15.0
