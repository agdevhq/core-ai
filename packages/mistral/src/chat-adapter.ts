...
// generated by another provider) and is preserved as <thinking> text rather
// than replayed as a native thinking chunk.
const MISTRAL_REASONING_METADATA_NAMESPACE = 'mistral';
    ...
    if (message.role === 'assistant') {
        ...
        for (const part of message.parts) {
            if (part.type === 'text') {
                ...
                const isNativeMistralReasoning =
                    getProviderMetadata(
