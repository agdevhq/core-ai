...
const otherCapabilities = getAnthropicModelCapabilities('claude-opus-4-8');
```

The capability fields describe reasoning effort, sampling constraints, and
tool choices for the model ID. See the
