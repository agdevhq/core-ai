...
<ParamField path="chat.compatibility" type="boolean" optional>
    Accept known nonstandard Chat Completions response fields. Defaults to
    `false`. For third-party gateways, prefer `@core-ai/openai-compat`.
</ParamField>
