---
title: Providers
description: Learn how providers work in core-ai and how to use OpenAI, Azure OpenAI, Anthropic, Anthropic on Vertex AI, Google GenAI, and Mistral
---

## Overview

Providers are the bridge between core-ai and LLM services like OpenAI, Azure OpenAI, Anthropic, Anthropic on Vertex AI, Google GenAI, and Mistral. Each provider implements a unified interface that abstracts away provider-specific details, allowing you to switch between providers with minimal code changes.
