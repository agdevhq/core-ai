...
Pass `providerOptions.xai` for xAI-specific options. Flagship Grok models always reason; core-ai preserves their reasoning across turns via `resultToMessage()`.
