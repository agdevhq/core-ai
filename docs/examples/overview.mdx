...
<Card
    ...
    icon="brackets-curly"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/15-generate-object.ts"
>
...
<Card
    ...
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/16-stream-object.ts"
>
  ...
  <Card
    title="Stream Abort"
    icon="circle-stop"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/17-stream-abort.ts"
  >
...
>
  ...
  <Card
    title="Kimi Provider"
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/14-kimi-provider.ts"
  >
...
- **15-generate-object.ts** - Generate structured JSON
- **16-stream-object.ts** - Stream structured data

### 4. Stream control

Manage in-flight streams:

- **17-stream-abort.ts** - Abort a stream with `AbortSignal`
