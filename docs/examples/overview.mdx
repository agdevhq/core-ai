...
<Card
    ...
    icon="google"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/09-google-provider.ts"
>
    Using Google (Gemini) with the same `generate()` API. Demonstrates
...
- **09-google-provider.ts** - Gemini models
