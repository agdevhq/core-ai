...
<Card
    ...
    icon="brackets-curly"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/17-generate-object.ts"
>
...
<Card
    ...
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/18-stream-object.ts"
>
  ...
  <Card
    title="Stream Abort"
    icon="circle-stop"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/19-stream-abort.ts"
  >
...
>
  ...
  <Card
    title="xAI Provider"
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/16-xai-provider.ts"
  >
...
- **17-generate-object.ts** - Generate structured JSON
- **18-stream-object.ts** - Stream structured data

### 4. Stream control

Manage in-flight streams:

- **19-stream-abort.ts** - Abort a stream with `AbortSignal`
...
- **16-xai-provider.ts** - xAI (Grok) models
