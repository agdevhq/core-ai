...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="brackets-curly"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/12-generate-object.ts"
  >
  ...
  <Card
    ...
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/13-stream-object.ts"
  >
  ...
  <Card
    title="Stream Abort"
    icon="circle-stop"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/14-stream-abort.ts"
  >
...
- **12-generate-object.ts** - Generate structured JSON
- **13-stream-object.ts** - Stream structured data

### 4. Stream control
Manage in-flight streams:
- **14-stream-abort.ts** - Abort a stream with `AbortSignal`
