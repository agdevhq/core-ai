...
>
  ...
  <Card
    title="xAI Provider"
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/21-xai-provider.ts"
  >
    Using the xAI API with Grok reasoning output and the same `generate()` API.
  </Card>
</CardGroup>
...
- **21-xai-provider.ts** - xAI (Grok) models
