...
<Card
    ...
    icon="brackets-curly"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/14-generate-object.ts"
>
...
<Card
    ...
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/15-stream-object.ts"
>
  ...
  <Card
    title="Stream Abort"
    icon="circle-stop"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/16-stream-abort.ts"
  >
...
>
  ...
  >
    Using Claude on Vertex AI with the same `generate()` API. Authenticates via Application Default Credentials.
  </Card>
</CardGroup>
...
- **14-generate-object.ts** - Generate structured JSON
- **15-stream-object.ts** - Stream structured data

### 4. Stream control

Manage in-flight streams:

- **16-stream-abort.ts** - Abort a stream with `AbortSignal`
