...
<Card
    ...
    icon="brackets-curly"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/13-generate-object.ts"
>
...
<Card
    ...
    icon="code"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/14-stream-object.ts"
>
  ...
  <Card
    title="Stream Abort"
    icon="circle-stop"
    href="https://github.com/agdevhq/core-ai/blob/main/examples/15-stream-abort.ts"
  >
