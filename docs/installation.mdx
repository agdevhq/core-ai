...
<Tabs>
  ...
  <Tab title="Google">
    ...
    ```bash yarn
    yarn add @core-ai/google
    ```

    ```bash pnpm
    pnpm add @core-ai/google
    ```
    </CodeGroup>

    <Note>
      The Google adapter supports chat, streaming, structured outputs, embeddings, multimodal input, and image generation.
    </Note>
  </Tab>
